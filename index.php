...
class Dav {
    ...
    private function HTML(){
        ...
        <div class="bar">
            ...
            <?php endif;?>
            <!-- Fixed: Split Upload Button for File and Folder -->
            <form method="post" enctype="multipart/form-data" style="margin:0;display:flex;gap:8px">
                ...
                <label class="btn bp" title="<?=T('up_folder')?>" style="padding:10px 14px"><?=$I['up_f']?><input type="file" name="f[]" hidden multiple webkitdirectory mozdirectory onchange="this.form.submit()"></label>
            </form>
